if (typeof lightdm == 'undefined') {
	...
	lightdm.sessions= [
	{"name": "GNOME", "key": "gnome", "comment": "Test"},
	{
	...
	{"name": "Ubuntu", "key": "ubuntu", "comment": "Test"}
];
	...
	lightdm.users= [
		...
		{ name: "Udara-U3", real_name:"Spiderman", display_name: "Udara Madubhashana", image :"", language: "en_US", layout: null, session: "ubuntu", logged_in: true}
	];
	lightdm.layouts = [
